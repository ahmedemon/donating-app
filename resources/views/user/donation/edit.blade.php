                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{ route('donation.update', $donation->id) }}" method="POST" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                            ...
                                            <div class="container d-flex justify-content-center mt-0 px-0">
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="donationImagePreview" style="background-image: url('{{ $donation->images ? asset('storage/donation/' . $donation->images) : asset('frontend/img/dummy-product.jpg') }}')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
