                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{ route('admin.category.store') }}" method="POST" class="form-valide-with-icon needs-validation">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="validationname" value="{{ old('name') }}" placeholder="Enter name here.." required>
                                            @error('name')
