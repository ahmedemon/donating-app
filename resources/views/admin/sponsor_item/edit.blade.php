@extends('layouts.admin.app', ['pageTitle'=>'Edit Sponsor'])
@push('croppercss')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.sponsor-item.update', $sponsor_item->id) }}" method="POST" class="form-valide-with-icon needs-validation" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                                ...
                                                <div class="container d-flex justify-content-center mt-0 px-0">
                                                    <div class="avatar-upload">
                                                        ...
                                                        <div class="avatar-preview">
                                                            <div id="sponsoredImagePreview" style="background-image: url('{{ $sponsor_item->image? asset('storage/sponsor_item/' . $sponsor_item->image): asset('frontend/img/dummy-product.jpg') }}')">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mb-3 row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="validateTitle" value="{{ old('title', $sponsor_item->title) }}" placeholder="Enter title here.." required>
                                                @error('title')
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-pen-alt"></i> </span>
                                                <input type="number" name="price" class="form-control" id="validatePrice" value="{{ old('price', intval($sponsor_item->price)) }}" placeholder="Enter price here.." required>
                                                @error('price')
                                                    <div class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-pen-alt"></i> </span>
                                                <input type="number" name="reward_point" class="form-control" id="validateRewardPoint" value="{{ old('reward_point', intval($sponsor_item->reward_point)) }}" placeholder="Enter reward point here.." required>
                                                @error('reward_point')
                                                    <div class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-pen-alt"></i> </span>
                                                <input type="text" name="shipping_address" class="form-control" id="validateShippingAddress" value="{{ old('shipping_address', $sponsor_item->shipping_address) }}" placeholder="Enter shipping address here.." required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select id="inputState" class="default-select form-control wide" name="sponsored_by" required>
                                                @foreach ($sponsors as $sponsor)
                                                    <option {{ $sponsor->id == $sponsor_item->sponsored_by ? 'selected' : '' }} value="{{ $sponsor->id }}">{{ $sponsor->company_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('sponsored_by')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-pen-alt"></i> </span>
                                                <textarea name="description" id="descriptionEditor" class="form-control" placeholder="Enter description here.." required>{{ old('description', $sponsor_item->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </div>
